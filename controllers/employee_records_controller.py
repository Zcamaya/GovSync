...
class EmployeeRecordsController:
    def __init__(self, service: EmployeeRecordsService | None = None):
        self.service = service or EmployeeRecordsService()

    def get_statistics(self, employer_id: str | None = None) -> dict[str, object]:
        return self.service.get_statistics(employer_id=employer_id)

    def get_filter_options(self, employer_id: str | None = None) -> dict[str, list[str]]:
        return self.service.get_filter_options(employer_id=employer_id)
    ...
    def get_employee_payroll_history(self, employer_id: str | None, employee_id: str = "", sss_number: str = "") -> list[dict]:
        return self.service.get_employee_payroll_history(employer_id=employer_id, employee_id=employee_id, sss_number=sss_number)
